...
public enum GlobalPruneTimer {
    ...
    public void create() {
        ...
        this.pruneTimer = new ScheduledThreadPoolExecutor(1, r -> ThreadUtil.newThread(r, String.format("Pure-Timer-%s", cacheTaskNumber.getAndIncrement())));
    }
